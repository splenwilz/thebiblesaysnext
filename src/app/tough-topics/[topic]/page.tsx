...
// import Post from './topics'

interface ToughTopicServerProps {
  params: { topic: string }
}
export default async function ToughTopicServer({
  params: { topic },
}: ToughTopicServerProps) {
  let theme = 'light'
      ...
      content: (
        <div className="">
          <div className="flex flex-row py-2 pl-0">
            ...
            <a
              className="font-lexend text-[15px] pl-4 dark:text-thebiblesayswhite-100 font-light"
              href="#"
            >
              Book Theme
            </a>
  ...
  try {
    const response = await fetch(
      `https://www.thebiblesays.com/wp-json/tbs/v1/post?slug=${topic}`,
    )
          ...
          <div className="w-full basis-auto sm:basis-1/2 lg:basis-2/3 flex flex-col">
            ...
            {error ? (
              <div className="bg-thebiblesaysoffwhite">
                <div className=" mx-auto max-w-[1440px] h-96 pb-24 px-7 md:px-10 lg:px-40">
              ...
              <div className="max-h-[1000px] overflow-scroll">
                <div className="flex flex-col m-10 pr-0 lg:pr-20">
                  <div className="flex flex-col justify-center">
                    ...
                    <img src={data?.image_url} alt="" className="w-full mb-8" />
                    {data?.content ? (
                      <div
