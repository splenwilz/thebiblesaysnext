...
// import BibleResource from './bibleresource'
// import axios, { AxiosResponse } from 'axios'
// import Skeleton from 'react-loading-skeleton'
// import 'react-loading-skeleton/dist/skeleton.css'

// const BibleComm = () => {
//   const [dataComm, setDataComm] = useState<CommentaryPost[] | null>(null)
...
//           `https://13.51.172.229/wp-json/tbs/v1/commentaries-by-passage-sorted?keyword=Genesis%201`,
//         )

//         setDataComm(response.data)
//         setLoadingComm(false)
//       } catch (error) {
//         setErrorComm(`Error fetching data: ${error ? error : ''}`)
//       } finally {
//         setLoadingComm(false)
//       }
//     }
...
//           <div className="mt-8 text-center text-red-600">{errorComm}</div>
//         </div>
//       </div>
//     )
//   }
...
//             <div className="  mb-10">
//               <div className="pb-5">
//                 <Skeleton className="font-lexend font-extrabold text-2xl mb-2" />
//                 <Skeleton count={5} className="font-serifpro mt-1 leading-8" />
//               </div>
//               <Skeleton
//                 count={100}
//                 className="mt-1 font-serifpro text-[17px] leading-8 scr pr-5 "
//               />
//             </div>
//           ) : (
//             <>
