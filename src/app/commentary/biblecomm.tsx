  ...
  const ScripturesTab = [
    {
      ...
      content: (
        <>
          {/* {bibleChapLoading ? (
            <>
              <Skeleton className="font-lexend text-2xl font-semibold mt-3 mb-5 dark:text-thebiblesayswhite-100" />
              <Skeleton
                className="font-lexend text-[15px] dark:text-thebiblesayswhite-100"
                count={100}
              />
            </>
          ) : ( */}
          <>
            <h4 className="font-lexend text-2xl font-semibold mt-3 mb-5 dark:text-thebiblesayswhite-100">
