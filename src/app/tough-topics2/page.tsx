...
import ToughTopicsLanding from './ToughTopicsLanding'
...
const ToughTopics: React.FC = () => {
  // const [isSearching, setIsSearching] = useState(false)
  // const [isSetting, setIsSetting] = useState(false)
  // const [activeItem, setActiveItem] = useState<number>(1)
  // const [theme, setTheme] = useState<string>('light')
  // const { data, error, loading } = useTopics()
  ...
  return (
    <>
      ...
      {/* <div className="dark:bg-thebiblesaysblack-100 ">
        <div className="flex flex-row mx-auto max-w-[1440px] px-10 lg:px-10 md:px-7 sm:px-7">
          <div className="w-full basis-auto sm:basis-1/2 lg:basis-2/3 flex flex-col">
            <div className="border hidden min-[948px]:flex flex-row py-4  border-t-thebiblesaysblack-16 border-b-thebiblesaysblack-16 dark:border-t-thebiblesayswhite-8 dark:border-b-thebiblesayswhite-8 border-r-0 border-l-0 px-10 ">
              <CommentaryDropdown
              ...
              <div className="">
                <CommentarySearch
                  ...
                  formClass=""
                  inputClass="h-[41px] border-gray-300 ml-2"
                />
                {isSearching && (
            ...
            <div className="border flex min-[948px]:hidden flex-col py-4  border-t-thebiblesaysblack-16 border-b-thebiblesaysblack-16 dark:border-t-thebiblesayswhite-8 dark:border-b-thebiblesayswhite-8 border-r-0 border-l-0 ">
              <div className="flex flex-row gap-5">
                ...
                <div className="">
                  <div className="ml-5 mt-2 flex flex-row gap-2 cursor-pointer">
                    <span
                      className="font-lexend font-bold text-thebiblesaysblack-100 dark:text-thebiblesayswhite-64 ml-2 md:ml-3"
                      onClick={handleTextSetting}
                    >
                      Aa
                    </span>
              ...
              <div className="">
                <CommentarySearch
                  ...
                  onFocus={handleSearchFocus}
                  formClass=""
                  inputClass="h-[41px] border-gray-300 ml-0 min-[948px]:p-0 min-[948px]:pl-0 min-[948px]:ml-2"
                />
                {isSearching && (
                  <div className="mt-2 ml-0 block absolute bg-thebiblesayswhite-100 dark:bg-thebiblesaysblack-100 w-72 dark:text-thebiblesayswhite-100 text-sm border dark:border-thebiblesayswhite-8 dark:focus:ring-thebiblesaysblack-40 dark:focus:border-thebiblesaysblack-40">
                    <div className="font-lexend text-[12px] ml-4 uppercase py-1 font-medium dark:text-thebiblesayswhite-100">
                      Books
                    </div>
                    <div className="border border-t-0 border-l-0 border-r-0 dark:border-thebiblesayswhite-8"></div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col mt-10 mb-10 sm:mr-10 pr-0 lg:pr-20">
