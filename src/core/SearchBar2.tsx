...
import CommentarySearch3 from './CommentarySearch3'
...
const SearchBar2: React.FC<SearchBarProps> = ({
  ...
  return (
    <>
      ...
      {isSearching && (
        <div
          className="relative z-10 mt-2 left-10"
          style={{ marginLeft: '18px' }}
        >
          <div
            className="mt-0 mr-0 md:ml-0 block absolute bg-thebiblesayswhite-100 dark:bg-thebiblesaysblack-100 w-72 dark:text-thebiblesayswhite-100 text-sm border dark:border-thebiblesayswhite-8 dark:focus:ring-thebiblesaysblack-40 dark:focus:border-thebiblesaysblack-40"
            // onBlur={h}
          >
