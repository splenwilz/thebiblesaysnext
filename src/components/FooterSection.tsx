...
const FooterSection: React.FC<FooterSectionProps> = ({ className }) => {
  ...
  return (
    <div className="bg-thebiblesaysblack-100">
      <div
        className={`biblical-card  mx-auto max-w-[1440px] px-40 ${className}`}
      >
          ...
          <div className="basis-1/2 h-100 flex flex-col ">
            ...
            <div className="flex mt-12 mb-12">
              <div className="flex mr-4 mt-3 w-38 p-3 border border-stone-300 cursor-pointer h-10 bg-black text-white rounded-md items-center justify-center">
                <div className="mr-3">
                  <svg viewBox="0 0 384 512" width="14">
                    <path
                      fill="currentColor"
                ...
                <div>
                  ...
                  <div className="font-semibold font-sans -mt-1 text-sm">
                    App Store
                  </div>
                </div>
              </div>
              <div className="flex mt-3 w-38 h-10 p-3 border border-stone-300 cursor-pointer bg-black text-white rounded-lg items-center justify-center">
                <div className="mr-3">
                  <svg viewBox="30 336.7 120.9 129.2" width="14">
                    <path
                      fill="#FFD400"
        ...
        <div className="grid md:grid-cols-2 justify-center md:justify-between border-0 border-t border-solid border-t-thebiblesayswhite-40 pt-6 pb-5">
          <p className="text-thebiblesayswhite-100 text-[15px] md:text-[13px] font-lexend mb-5 md:mb-0">
